...
#       | "Content Editor" | "node/add/event"  |
#       | "Content Editor" | "node/add/offering" |
...
#   @api @ultopic
#   Scenario Outline: Make sure we can create a Homepage, Industry Landing Page, Overview and Solution.
#     Given I am logged in as a user with the <role> role
#     And I visit <path>
#     Then I should get a 200 HTTP response
#     And I should see the button "Save and Create New Draft"
...
#     Examples:
#       | role             | path                 |
#       | "Content Author" | "node/add/article" |
#       | "Content Author" | "node/add/event" |
#       | "Content Author" | "node/add/homepage" |
#       | "Content Author" | "node/add/industry_landing"  |
#       | "Content Author" | "node/add/overview"  |
#       | "Content Author" | "node/add/page" |
#       | "Content Author" | "node/add/solution" |
#       | "Content Author" | "node/add/standards" |
#       | "Content Editor" | "node/add/article" |
#       | "Content Editor" | "node/add/event" |
#       | "Content Editor" | "node/add/homepage" |
#       | "Content Editor" | "node/add/industry_landing"  |
#       | "Content Editor" | "node/add/overview"  |
#       | "Content Editor" | "node/add/page" |
#       | "Content Editor" | "node/add/solution" |
#       | "Content Editor" | "node/add/standards" |

#   @api @ultopic
#   Scenario Outline: Make sure some roles cannot create content.
#     Given I am logged in as a user with the <role> role
#     When I am on <path>
#     Then I should see "Access denied"
#     And I should get a 403 HTTP response
...
#     Examples:
#       | role             | path                 |
#       | "Content Approver" | "node/add/article" |
#       | "Content Approver" | "node/add/event" |
#       | "Content Approver" | "node/add/homepage" |
#       | "Content Approver" | "node/add/industry_landing"  |
#       | "Content Approver" | "node/add/overview"  |
#       | "Content Approver" | "node/add/page" |
#       | "Content Approver" | "node/add/solution" |
#       | "Content Approver" | "node/add/standards" |
